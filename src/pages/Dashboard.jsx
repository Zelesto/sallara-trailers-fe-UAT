...
// ============================================================
const FuelEfficiencyCard = ({ fuelStats, mostEfficientVehicle, topDrivers }) => {
  return (
    <Paper
      sx={{
        p: { xs: 2, sm: 2.5 },
    ...
    >
      <Typography variant="subtitle2" sx={{ fontWeight: 600, mb: 1.5 }}>
        <LocalGasStation sx={{ fontSize: '0.9rem', verticalAlign: 'middle', mr: 0.5 }} />
        Fuel Efficiency Breakdown
      </Typography>
      <Grid container spacing={1.5}>
        <Grid size={{ xs: 6, md: 3 }}>
          <Box sx={{ textAlign: 'center', p: 1.5, bgcolor: '#F9FAFB', borderRadius: 1 }}>
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.6rem' }}>Full Fleet</Typography>
            <Typography variant="h6" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' }, fontWeight: 700 }}>
              {fuelStats?.avgEfficiency?.toFixed(1) || 0} km/L
            </Typography>
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.55rem' }}>
              {formatCurrency(fuelStats?.avgCostPerKm || 0)}/km
            </Typography>
          </Box>
        </Grid>
        <Grid size={{ xs: 6, md: 3 }}>
          <Box sx={{ textAlign: 'center', p: 1.5, bgcolor: '#DBEAFE', borderRadius: 1 }}>
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.6rem' }}>Best Vehicle</Typography>
            <Typography variant="h6" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' }, fontWeight: 700 }}>
              {mostEfficientVehicle?.efficiency?.toFixed(1) || 0} km/L
            </Typography>
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.55rem' }}>
              {mostEfficientVehicle?.registration || 'N/A'}
            </Typography>
          </Box>
        </Grid>
        <Grid size={{ xs: 6, md: 3 }}>
          <Box sx={{ textAlign: 'center', p: 1.5, bgcolor: '#D1FAE5', borderRadius: 1 }}>
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.6rem' }}>Best Driver</Typography>
            <Typography variant="h6" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' }, fontWeight: 700 }}>
              {topDrivers?.[0]?.efficiency?.toFixed(1) || 0} km/L
            </Typography>
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.55rem' }}>
        ...
        <Grid size={{ xs: 6, md: 3 }}>
          <Box sx={{ textAlign: 'center', p: 1.5, bgcolor: '#FEF3C7', borderRadius: 1 }}>
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.6rem' }}>Total Cost</Typography>
            <Typography variant="h6" sx={{ fontSize: { xs: '0.9rem', sm: '1rem' }, fontWeight: 700 }}>
              {formatCurrency(fuelStats?.totalFuelCost || 0)}
            </Typography>
            <Typography variant="caption" color="text.secondary" sx={{ fontSize: '0.55rem' }}>
              {fuelStats?.totalFuel?.toFixed(0) || 0} L used
            </Typography>
          </Box>
        </Grid>
      </Grid>
...
// TOP DRIVERS TABLE
// ============================================================
const TopDriversTable = ({ drivers, loading }) => {
  if (loading) {
    return (
    ...
    <TableContainer>
      <Table size="small">
        <TableHead sx={{ bgcolor: '#F9FAFB' }}>
          <TableRow>
            <TableCell sx={{ fontSize: { xs: '0.6rem', sm: '0.7rem' }, fontWeight: 600, color: '#6B7280' }}>
              Driver
            </TableCell>
            <TableCell sx={{ fontSize: { xs: '0.6rem', sm: '0.7rem' }, fontWeight: 600, color: '#6B7280' }} align="center">
              Efficiency
            </TableCell>
            <TableCell sx={{ fontSize: { xs: '0.6rem', sm: '0.7rem' }, fontWeight: 600, color: '#6B7280' }} align="center">
              Trips
      ...
      <Box sx={{ 
        ...
        >
          ...
          <Grid size={{ xs: 12, lg: 8 }} sx={{ display: 'flex' }}>
            ...
            >
              <Typography variant="h6" sx={{ fontWeight: 600, fontSize: { xs: '0.9rem', sm: '1rem' }, mb: 2 }}>
                <Star sx={{ fontSize: '0.9rem', verticalAlign: 'middle', mr: 0.5, color: '#F59E0B' }} />
          ...
          <Grid size={{ xs: 12, lg: 4 }} sx={{ display: 'flex' }}>
            ...
            >
              <Typography variant="h6" sx={{ fontWeight: 600, fontSize: { xs: '0.9rem', sm: '1rem' }, mb: 2 }}>
                <Notifications sx={{ fontSize: '0.9rem', verticalAlign: 'middle', mr: 0.5 }} />
                Recent Activity
              </Typography>
